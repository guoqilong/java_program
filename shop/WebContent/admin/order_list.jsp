	...
	<div class="rt_content">
		...
		<section class="mtb">
			<input type="text" class="textbox textbox_225"
				placeholder="输入订单编号或收件人姓名/电话..." /> <input type="button" value="查询"
				class="group_btn" />
		</section>
		<table class="table">
			<tr>
			...
			<c:forEach items="${orderlist }" var="item">
				<tr>
					...
					<td class="center"><a href="orderdetail?id=${item.id }"
						title="查看订单" class="link_icon" target="_blank">&#118;</a> <a
						href="deleteorder?id=${item.id }" title="删除" class="link_icon">&#100;</a>
					</td>
				</tr>
			</c:forEach>
			<!-- <tr>
