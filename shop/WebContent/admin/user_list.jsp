	...
	<div class="rt_content">
		...
		<table class="table">
			...
			<c:forEach items="${userlist }" var="u">
				<tr>
					<td class="center"><img src="../icons/${u.iconPath }"
					...
					<td class="center"><a href="userdetail?id=${u.mail }"
						title="编辑" class="link_icon">&#101;</a> <a
						href="deleteuser?id=${u.mail }" title="删除" class="link_icon">&#100;</a>
					</td>
				</tr>
			</c:forEach>
		</table>
