	...
	<div class="rt_content">
		...
		<section class="mtb">
			<form action="search" method="get">
				<input type="text" name="keyword" class="textbox textbox_225"
					placeholder="输入产品关键词..." /> <input type="submit" value="查询"
					class="group_btn" />
			</form>
		</section>
		<table class="table">
			...
			<c:forEach items="${productlist}" var="p">
				<tr>
					<td class="center"><img src="../images/${p.photo}" width="50"
						height="50" /></td>
					<td>${p.name}</td>
					...
					<td class="center"><a href="changeproduct_detail?id=${p.id}"
						title="编辑" class="link_icon">&#101;</a> <a
						href="deleteproduct?id=${p.id }" title="删除" class="link_icon">&#100;</a>
					</td>
				</tr>
			</c:forEach>
			<!-- <tr>
