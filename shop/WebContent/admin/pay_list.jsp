...
<section class="rt_wrap content mCustomScrollbar">
	<div class="rt_content">
		...
		<table class="table">
			...
			<tr>
				<td class="center"><img src="upload/alipay.png" width="165"
					height="65" /></td>
				<td>支付宝</td>
				<td><p>支付宝,全球领先的独立第三方支付平台,致力于为广大用户提供安全快速的电子支付/网上支付/安全支付/手机支付体验,及转账收款/水电煤缴费/信用卡还款/AA收款等生活...</p></td>
				<td class="center"><a href="product_detail.jsp" title="编辑"
					class="link_icon">&#101;</a> <a href="#" title="删除"
					class="link_icon">&#100;</a></td>
			</tr>
			<tr>
				<td class="center"><img src="upload/tenpay.png" width="165"
					height="65" /></td>
				<td>财付通</td>
			...
			<tr>
				<td class="center"><img src="upload/wechatpay.png" width="165"
					height="65" /></td>
				<td>微信支付</td>
