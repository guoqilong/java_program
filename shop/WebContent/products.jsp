				...
				<div class="col-md-4 col-md3" style="margin-bottom: 45px;">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="single.jsp"> <img
							style="display: block; width: 185px; height: 207px;"
							class="img-responsive" src="images/${p.photo }" alt="" />
						</a>
						<h3>
							<a href="single.jsp">${p.name }</a>
						</h3>
						<div class="price">
							<h5 class="item_price">$${p.price }</h5>
							<a href="javascript:void(0)" class="item_add"
								onclick="addProduct(${p.id})">Add To Cart</a>
				...
				<c:forEach items="${hotproductlist}" var="p">
					<div class="product-go">
						<div class=" fashion-grid">
							<a href="single?productid=${p.id }"><img
								class="img-responsive " src="images/${p.photo }" alt=""></a>
						</div>
						<div class=" fashion-grid1">
							<h6 class="best2">
								<a href="single?productid=${p.id }">${p.name } </a>
							</h6>
