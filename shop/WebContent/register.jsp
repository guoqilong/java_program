	...
	<div class="register">
		...
		<form action="regist" method="post" enctype="multipart/form-data">
			<div class="col-md-6  register-top-grid">
				...
				<div class="mation">
					<span>用户名</span> <input type="text" id="name" onblur="nameCheck()"
						name="name" />
					<!-- 邮箱验证 -->
					<span>邮箱</span> <input type="text" onblur="sendForm()"
						id="mail" name="mail" /> <span>Your Icon</span> <input type="file"
						name="file" />
				</div>

				<div class="clearfix"></div>
				<a class="news-letter" href="#"> <label class="checkbox"><input
						type="checkbox" name="checkbox" checked=""><i> </i>登录</label>
				</a>
			</div>
			<div class=" col-md-6 register-bottom-grid">
				...
				<div class="mation">
					<span>密码</span> <input type="text" id="password"
						onblur="passwordCheck()" name="password" /> 
					<span>确认密码</span> <input type="text" id="repassword"
